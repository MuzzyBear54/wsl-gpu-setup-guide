...
> Documentation and Makefiles for compiling CUDA-accelerated scientific codes on WSL2 (CUDA 11.8 + MPI + HDF5 via NVIDIA HPC SDK), including source patches to resolve WSL2/MPI environment quirks.

---

## License

If you publish this repo publicly, **MIT** is a common choice for documentation + small helper scripts:
- lets others reuse/adapt with minimal friction
- keeps attribution simple
- compatible with most academic/industry environments

If your lab prefers a specific license, swap it.
